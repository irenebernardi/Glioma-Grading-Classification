...
On the other hand, IDH mutations are not usually present in primary Glioblastomas, which emerge spontaneously in patients with no prior history of glioma. In these cases, mutations usually occur on the proto-oncogene EGFR and on the phosphatase and tensin homologue PTEN.

Interestingly, about 80% of grades II and III oligodendrogliomas, astrocytomas, and secondary glioblastomas exhibit mutually exclusive IDH1 and IDH2 mutations, highlighting their significance in tumor classification. Glioma molecular classification primarily distinguishes between IDH-mutant and IDH-wild tumors, the latter being predominantly represented by World Health Organization (WHO) grade IV primary glioblastomas. 
